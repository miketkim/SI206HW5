...
## (note that this will be in GMT time) of the first THREE tweets with at least 1 blank line in between each of them. 
...
# and use the process we discuss in class to make that information secure! 
...
try:
	...
	cache_file.close() # close that file when were done with i
except:
	CACHE_DICTION = {}
